...
const h1_public_mint = "Open for Public Minting, Bro!";
const h2_presale_coming_soon = "Pre-Sale Minting Countdown";
const h2_presale_mint = "Public Minting Countdown";
const p_presale_coming_soon = "Gain access to the limited pre-sale on April 8.";
...
const button_presale_already_minted = "Join The Discord";
